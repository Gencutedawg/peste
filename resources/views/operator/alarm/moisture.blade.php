...
<div class="page-header">
    <h1 class="page-title">
        <i class="bi bi-exclamation-triangle"></i> Moisture Content Alarm
    </h1>
    <p class="page-subtitle">Monitor moisture content-related alarms and alerts</p>
</div>

<div class="row">
    <div class="col-lg-8">
        <div class="content-card">
            <h3>Moisture Alarm Status</h3>
        ...
        <div class="content-card">
            ...
            <p>This section displays moisture content-related alarms and alerts. You can:</p>
            <ul style="color: #6c757d; line-height: 1.8;">
                <li>View active moisture alarms</li>
